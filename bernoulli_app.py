...
It also calculates the Reynolds Number, Moody's Friction Factor, and Major Friction Loss in one section.
""")
...
# New section for Reynolds Number, Moody's Friction Factor, and Major Friction Loss
st.header("Pipe Flow Calculations")

# Input fields for Reynolds Number, Moody's Friction Factor, and Major Friction Loss
st.write("### Pipe Flow Parameters")
...
pipe_roughness = st.number_input("Pipe roughness (ε, m)", value=0.0001, format="%f", help="Roughness of the pipe's inner surface.")
flow_velocity = st.number_input("Flow velocity (v, m/s)", value=None, format="%f", help="Velocity of the fluid in the pipe.")

# Calculate Reynolds Number, Moody's Friction Factor, and Major Friction Loss
if st.button("Calculate Pipe Flow Parameters"):
...
4. Use the sections below to calculate pipe flow parameters and power.
""")
